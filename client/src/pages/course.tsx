        ...
        <div className="p-6 flex-1 overflow-y-auto">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-primary">
                Module {courseState.currentModule?.orderIndex ? courseState.currentModule.orderIndex + 1 : 1} • Activity {activity.orderIndex + 1}
              </span>
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-medium text-blue-900 mb-2">About This Lesson</h3>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <h3 className="font-medium text-yellow-900 mb-2">Key Takeaways</h3>
              <ul className="text-yellow-800 text-sm space-y-1">
                <li>• Understand the core concepts</li>
                <li>• Apply what you learn in practice</li>
